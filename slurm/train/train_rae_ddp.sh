...
# echo "Syncing features from $REEF_SCRATCH_ROOT/features/ to $REEF_SCRATCH_NODE_ROOT/features/..."
# rsync -av --progress "$REEF_SCRATCH_ROOT/features/" "$REEF_SCRATCH_NODE_ROOT/features/"

# echo "Syncing depth data from $REEF_SCRATCH_ROOT/depth/ to $REEF_SCRATCH_NODE_ROOT/depth/..."
# rsync -av --progress "$REEF_SCRATCH_ROOT/depth/" "$REEF_SCRATCH_NODE_ROOT/depth/"
