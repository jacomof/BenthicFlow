...
SCRATCH_ROOT = Path(os.environ.get("REEF_SCRATCH_ROOT", PROJECT_ROOT / "scratch"))
SCRATCH_NODE_ROOT = Path(os.environ.get("REEF_SCRATCH_NODE_ROOT", SCRATCH_ROOT / "node"))

# Pipeline variant. REEF_VARIANT=dpf selects the BenthicFlow-DPF data roots
...
VARIANT = os.environ.get("REEF_VARIANT", "").lower()
...
print(f"--- REEF initialized at {PROJECT_ROOT} (variant: {VARIANT or 'base'}) ---")
