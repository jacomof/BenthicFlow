...
"""
    if model == "klein":
        ...
        transformer = Flux2Transformer2DModel.from_pretrained(
            KLEIN_ID, subfolder="transformer", torch_dtype=torch.bfloat16, device_map="cpu"
        )
        ...
        raise ValueError(f"Unknown model '{model}' (expected 'klein', 'dev', or 'flux1-dev')")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", choices=["klein", "dev", "flux1-dev"], default="klein",
