...
def load_rae_frozen(ckpt_path: Path, device: torch.device,
                    depth_activation: str | None = None) -> RAE:
    ...
    dec_kwargs = {} if depth_activation is None else {"depth_activation": depth_activation}
    rae_cfg = RAEConfig(
