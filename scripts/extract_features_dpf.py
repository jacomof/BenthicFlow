# DPF-Net (BenthicFlow-DPF) variant of scripts/extract_features.py.
...
def crawl_data_directory() -> dict[tuple[str, str], list[Path]]:
    ...
    deployments = {}
    print(f"Crawling data directory: {DATA_ROOT}")
    ...
    print(f"Discovered {len(deployments)} deployments in {DATA_ROOT}")
