...
├── env.sh           file and storage configurations sourced by every job (edit me to conform to your local setup)
└── requirements.txt pip dependencies required to run the project
```
